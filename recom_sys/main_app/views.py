...
def recommendation_view(request):
    if request.method == 'POST':
        ...
        return render(request, 'recommendation_result.html', {'recommendations': recommendations})
    else:
        ...
        return render(request, 'prod_select.html', {'customer_ids': customer_ids, 'product_ids': product_ids})
